...
export default class Users{
    ...
    createProfile(obj) {
        ...
        return new Promise((resolve, reject) => {
            this.client.query(query, [obj.username ,obj.first_name, obj.last_name, obj.email, obj.password,
            obj.gender, obj.phone, obj.birth_date, obj.type, obj.country, obj.description], (err, result) => {
                if(err) reject(err);
